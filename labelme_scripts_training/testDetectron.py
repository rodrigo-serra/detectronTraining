...
cfg.MODEL.WEIGHTS = os.getcwd() + "/model/output/instance_segmentation/model_final.pth"
...
metadata_save_path = os.getcwd() + "/model/dataset_metadata.json"
...
if not runVideo:
    img_path = "dataset/test/image_182_jpg.rf.c506e7f901197e7d9fe8fb0253255c62.jpg"
